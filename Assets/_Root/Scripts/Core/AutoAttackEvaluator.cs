...
public class AutoAttackEvaluator : MonoBehaviour
{
   public class FactionMemberParallelInfo
    ...
    public static ConcurrentDictionary<GameObject, FactionMemberParallelInfo> 
        FactionMembersInfo = new ConcurrentDictionary<GameObject, FactionMemberParallelInfo>();
